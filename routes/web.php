...
/*
|--------------------------------------------------------------------------
| Rotas de Autenticação de Atletas (Login Único por Instituição)
|--------------------------------------------------------------------------
*/
Route::get('/aluno/login',  [AlunoAuthController::class, 'showLogin'])
    ->name('aluno.login');
Route::post('/aluno/login', [AlunoAuthController::class, 'login'])
    ->name('aluno.login.post');
Route::post('/aluno/logout', [AlunoAuthController::class, 'logout'])
    ->name('aluno.logout');
...
Route::get('/analise',                     [AlunoPublicoController::class,    'index'])
    ->name('analise.index');
Route::get(
    '/analise/instituicao/{instituicao}/alunos',
    [AlunoPublicoController::class, 'listarPorInstituicao']
)
    ->name('analise.alunos')
    ->middleware('throttle:60,1');
Route::get(
    '/analise/aluno/{matricula}',
...
Route::middleware(CheckSession::class)->group(function () {
    ...
    // dashboard de técnicos (antigo /aluno/dashboard)  
