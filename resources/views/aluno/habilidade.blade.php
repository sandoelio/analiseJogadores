...
<style>
  ...
  .saude-item label { margin-bottom: 0; font-weight: 500; flex: 1; }
  .saude-radios { display: flex; gap: 1rem; flex-shrink: 0; }
  ...
  @media (max-width: 576px) {
    ...
    .habilidade-card-body .row.g-3 { margin-left: 0; margin-right: 0; }
      ...
      <div class="card-body habilidade-card-body">
        ...
        <form action="{{ route('aluno.habilidade.update') }}" method="POST">
          ...
          <ul class="nav nav-tabs" role="tablist">
            <li class="nav-item"><a class="nav-link active" data-bs-toggle="tab" href="#aba1" role="tab">Identificação</a></li>
            <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#aba2" role="tab">Habilidades Técnicas</a></li>
            <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#aba3" role="tab">Atributos Físicos</a></li>
            <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#aba4" role="tab">Composição Corporal</a></li>
                  ...
                  <div class="col-12 saude-item">
                    ...
                    <div class="saude-radios">
                      <div class="form-check">
                        <input class="form-check-input" type="radio" name="{{ $campo }}" id="{{ $campo }}_sim" value="1" disabled>
                        <label class="form-check-label" for="{{ $campo }}_sim">Sim</label>
                      </div>
                      <div class="form-check">
                        <input class="form-check-input" type="radio" name="{{ $campo }}" id="{{ $campo }}_nao" value="0" disabled>
          ...
          <div class="mt-4">
            <div class="d-grid d-md-flex justify-content-md-between actions-wrap">
              <button type="submit" class="btn btn-navbar-blue flex-md-grow-1">Atualizar Atleta</button>
        ...
        saude.forEach(name => {
          ...
          if (sim && nao) {
            if (val === 1 || val === '1' || val === true) {
              sim.checked = true; nao.checked = false;
            } else if (val === 0 || val === '0' || val === false) {
              sim.checked = false; nao.checked = true;
            } else {
              sim.checked = false; nao.checked = false;
            }
          }
        });
      })
